...
let REG_UN = {
	...
	// 循环分支，青
	loopFork: 'for|\sin\s|of|while|\sdo|if|else|switch|case|break|continue|try|catch|finally|with',
	// 方法关键字，蓝
	methodKeyword: 'return|delete|typeof|require|throw|eval|instanceof|debugger|this|true|false|undefined|null|length',
	// 类型方法，紫
	type: 'window|document|console|Object|Array|Boolean|String|Number|Math|Date|RegExp|Error|JSON'
}
...
REG.unComment = /http:\/\/|https:\/\/|ws:\/\/|wss:\/\/|[\w\*]\/\*|[\w\*]\*\//g
