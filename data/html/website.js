commonData.html.website = {
	...
	!./imgs/html/website01.png,800
	如果不知道密码的话可以重置
	若要修改远程连接密码（6位），需要重启才能生效需慎重选择
	!./imgs/html/website02.jpg,800
	若要修改实例密码（账号名通常为root，这里以Linux为例），也需要重启才能生效需慎重选择
	!./imgs/html/website03.jpg,800
