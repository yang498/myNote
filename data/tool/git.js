...
2005 年，开发 BitKeeper 的商业公司与 Linux 内核开源社区的合作关系结束，他们收回了 Linux 内核社区免费使用 BitKeeper 的权力。 
这就迫使 Linux 开源社区（特别是 Linux 的缔造者 Linus Torvalds）基于使用 BitKeeper 时的经验教训，开发出自己的版本系统 - Git。

#起步

##安装
从 @[Git 官网|https://git-scm.com/downloads] 下载安装
这里使用命令行的形式，在项目目录中右键选择·Git Bash Here·，而会了命令行形式自然也理解了图形界面的操作·Git GUI Here·
...
##概念
![http://www.ruanyifeng.com/blogimg/asset/2015/bg2015120901.png,800]
!!
