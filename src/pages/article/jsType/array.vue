...
slice(start, end)：提取目标数组的一部分，返回一个新数组，参数可以是负数表示倒数，若·start·大于·end·则返回空数组
    start{n}[0]：开始位置
...
every(fn(item, index, arr), thisObj)：遍历判断若参数函数的返回值全都是·true·则结果为·true·，否则·false·，参数的说明同·map()·
